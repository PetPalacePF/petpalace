...
export const OrderStatus = () => {
  ...
  if (buyNow) {
    ...
    putOrders(alternativeCart, order);
  } else {
    orderToSend = order;
  }

  const orders = [orderToSend?.id];
        ...
        <div className="mt-4">
          {
            stripe_payment_status === "succeeded" ? (
              <div>
                <div className="bg-green-200 border border-green-400 p-4 mb-4">
                  ...
                  <p className="mt-4 text-mg text-gray-700 font-bold leading">
                    An email has been sent to {userInfo?.email} with the details
                    of your purchase.
                  </p>
                </div>
                <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                  <div className="flex flex-row justify-between">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-gray-700">
                      Order #{orderToSend.id}
                    </h3>
                  </div>
                  <p>
                    Thank you for choosing PetPalace. Your order has been
                    processed. Read important information below.
                  </p>
                  <div className="flex flex-col mt-4">
                    <h1 className="h-10 uppercase text-lg font-bold">
                      PRODUCTS:
                    </h1>
                  ...
                  <div>
                    ...
                    <div className="flex flex-col justify-between">
                      <p className="font-medium">
                        {userInfo?.street_address} {userInfo?.street_number},{" "}
              ...
              <div className="bg-green-200 border border-green-400 p-4 mb-4">
                ...
                <p className="mt-4 text-mg text-gray-700 font-bold leading">
                  An error ocurred while processing your payment. Please go back
                  and retry or continue shopping.
                </p>
                <div>
                  <NavLink
                    to="/cart/purchase"
