        ...
        <div className="flex flex-col items-center justify-center w-full">
            ...
            <div className="flex h-screen mt-4 space-x-8">
                ...
                <div className="flex-1 p-4">
                    ...
                    <div className='mt-4'>
                        {!result ? (
                            <button to="" className='h-8 uppercase font-medium border flex justify-center items-center bg-black text-white w-full' type="button" disabled>Add shipping address</button>
                        ) : (
                            <button to="/cart/purchase"
                            className='h-8 uppercase font-medium border flex justify-center items-center bg-black text-white w-full'
                            onClick={makePayment}>
                            buy now!
                        </button>
                            )}
                        <NavLink to='' className='h-8 uppercase font-medium border flex justify-center items-center mt-2'>Modify Order</NavLink>
                    </div>
                </div>
            </div>
        </div>
